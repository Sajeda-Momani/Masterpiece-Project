                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <br>
                                                        <textarea name="brief" id="description" cols="50" rows="2" class="summernote" placeholder=" Product Brief"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <br>
                                                        <textarea name="description" id="description" cols="50" rows="5" class="summernote"
