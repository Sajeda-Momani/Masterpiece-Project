                ...
                <div class="container">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-3 col">
                            ...
                            <li><a href="{{ route('account') }}"><i class="fa fa-user fa-lg"></i> </a></li>
                            <li><a href="{{ route('login') }}"><i class="fa fa-sign-in fa-lg" style="color: white;"></i> </a></li>
        ...
        <div class="container">
            <div class="header-nav">
                <div class="main-menu position-relative">
                    <ul>
                        <li><a href="{{ route('home') }}">Home <i class="fa fa-angle"></i></a>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="{{ route('singleproduct') }}" class="image"><img
                                src="{{ asset('imagesproduct-image/1.png') }}" alt="Cart product Image"></a>
                        <div class="content">
                            <a href="{{ route('singleproduct') }}" class="title">Apple TV 4K 128GB</a>
                    ...
                    <li>
                        ...
                        <div class="content">
                            <a href="{{ route('singleproduct') }}" class="title">Blink Outdoor Wire</a>
                    ...
                    <li>
                        ...
                        <div class="content">
                            <a href="{{ route('singleproduct') }}" class="title">Arlo Wired Wi-Fi Video
                                Doorbell</a>
